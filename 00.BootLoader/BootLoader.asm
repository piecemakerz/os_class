...
; 현재 DL=일자, DL=달, CX=년도가 저장되어 있다.
	...
	add bx, cx       ; 만약 올해가 1901년 1월이라면
	sub bx, 1900     ; 년도에 따른 날짜차이에는 1901년-1900년 1년
	dec cx           ; 년도에 따른 윤년차이에는 1900년 2월만이 반영되어야 한다

	; 윤년 계산
	; 1900년 부터 작년까자의 윤년의 횟수는 작년까지의 윤년의 개수에서
	; 1899년까지의 윤년의 개수를 빼서 구할 수 있다
	...
	; 1900년까지의 윤년은
	; 1899 / 4 + 1899 / 400 - 1899/100이고 이는
	; 474 + 4 - 18로 460 번 발생했다
